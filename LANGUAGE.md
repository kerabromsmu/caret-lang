...
Its common enumeration, size, guarantee, reflection, `Natural`, and empty-Collection foundation is
implemented; the remaining integration points are planned. General
