...
| `CONTRACT-001`, `CONTRACT-CORE-001`, `CONTRACT-003`, `CONTRACT-005` | `contracts.caret`; built-in, derived, nullable, and optional predicates, binding/parameter/result clauses, partial application, and reflection |
